package com.catata.roomexample.framework.ui.main.viewmodel
...
import com.catata.roomexample.framework.database.TasksDatabase
...
class TaskViewModel(application: Application): AndroidViewModel(application) {
    ...
    var myDao: LocalDataSource = TasksDatabase.getInstance(context)
