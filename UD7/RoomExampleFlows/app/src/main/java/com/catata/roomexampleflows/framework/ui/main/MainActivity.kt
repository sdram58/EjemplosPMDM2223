package com.catata.roomexampleflows.framework.ui.main
...
import com.catata.roomexampleflows.framework.ui.adapters.TasksAdapter
import com.catata.roomexampleflows.databinding.ActivityMainBinding
import com.catata.roomexampleflows.domain.Task
import com.catata.roomexampleflows.framework.ui.main.viewmodel.TaskViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MainScope().launch {
            taskViewModel.updateTaskStateFlow.collect{ taskUpdated ->
                if(taskUpdated == null){
        ...
        MainScope().launch {
            taskViewModel.deleteTaskStateFlow.collect{ id ->
                if(tasks.isNotEmpty()){
                    if(id != -1){
