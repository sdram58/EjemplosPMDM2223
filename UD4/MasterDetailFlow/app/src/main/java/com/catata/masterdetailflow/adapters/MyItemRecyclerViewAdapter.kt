package com.catata.masterdetailflow.adapters
...
import com.catata.masterdetailflow.databinding.ListItemBinding
...
class MyItemRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.ivPoster.setImageFromString(superhero.photo)
